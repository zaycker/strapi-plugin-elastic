   ...
   renderLinks = () => {
     ...
     return map(linksOptions, (linksOption, key) => (
       <li className={cn(linksOption.isActive && 'navLiActive')} key={key}>
         <a href="#" onClick={linksOption.isActive ? linksOption.handleClick : noop}>
           {linksOption.value}
         </a>
       </li>
     ));
       ...
       <Wrapper>
         <div>
           <a
             ...
             onClick={this.isFirstPage() ? this.handlePreviousPageClick : noop}
           >
           ...
           <a
             href="#"
             className="paginationNavigator"
             onClick={this.isLastPage() ? this.handleNextPageClick : noop}
           >
